    ...
    protected void paintComponent(final Graphics graphics) {
        ...
        if (!gameStarted) {
            ...
            for (final var point : snake) {
                ...
                snakeColor = new Color(0, 0, newBlue);
            }
        ...
        if (!snake.isEmpty()) {
                ...
                graphics.setFont(graphics.getFont().deriveFont(20F)); // Change font size if needed
                final var graphics2D = (Graphics2D) graphics;
                final var frc = graphics2D.getFontRenderContext();
                final var layout = new TextLayout(snakeName, graphics.getFont(), frc);
                final var bounds = layout.getBounds();
                float x = head.x + (cellSize - (float) bounds.getWidth()) / 2; // Centered text
                float y = head.y - 4; // Position text above the head
            ...
            if (gameOver) {
                ...
                printMessage(graphics, "Score: " + currentScore
